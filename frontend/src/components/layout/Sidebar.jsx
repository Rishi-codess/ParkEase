...
import {
  ...
  FaMoneyBillWave, FaExclamationTriangle, FaCalendarAlt,
} from "react-icons/fa";
...
const plainClass =
  "flex items-center gap-3 px-3 py-2.5 rounded-xl transition-all text-sm font-medium text-gray-400 hover:bg-white/5 hover:text-white w-full text-left";
        ...
        {role === "ADMIN" && (
          <>
            ...
            <NavLink className={linkClass} to="/admin/bookings">
              <FaCalendarAlt className="flex-shrink-0" /> Bookings
            </NavLink>

            <p className="text-[10px] text-gray-600 uppercase tracking-widest px-3 mb-2 mt-4">Finance</p>
            <NavLink className={linkClass} to="/admin/payments">
            ...
            <NavLink className={linkClass} to="/admin/ghost">
              <FaExclamationTriangle className="flex-shrink-0 text-neon-red" />
