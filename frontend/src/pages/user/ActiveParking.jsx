...
export default function ActiveParking() {
    ...
    const expiresAtMs = useMemo(() => bookedAt.getTime() + totalDuration * 3600000, [bookedAt, totalDuration]);
    ...
    const timerColor = expired
        ? "text-neon-red"
        : hours === 0 && mins < 15 ? "text-yellow-400"
        : "text-neon-green";
            ...
            <div className="max-w-2xl mx-auto">
                ...
                >
                    ...
                    <div>
                        ...
                        <p className="text-neon-green/80 text-sm mt-0.5">Payment successful · Slot is now locked for you</p>
                    </div>
                </motion.div>
                    ...
                    {expired && (
                        ...
                        >
                            ...
                            <div className="flex-1">
                                <p className="text-neon-red font-black text-sm uppercase tracking-wide mb-1">Parking Time Exceeded — Penalty Running</p>
                                <p className="text-gray-400 text-xs">₹{PENALTY_PER_INTERVAL} penalty per 15 minutes of overtime.</p>
                ...
                >
                    ...
                    <div className="p-7">
                        ...
                        <div className="grid grid-cols-2 gap-4 mb-6">
                            ...
                            <InfoTile icon={<span className="text-neon-purple font-black text-lg">#</span>} label="Slot ID" value={<span className="font-mono text-neon-purple font-black">{booking.slotId}</span>} />
                            ...
                            <InfoTile icon={<FaRupeeSign className="text-neon-green text-lg" />}      label="Total Paid" value={<span className="text-neon-green font-black">₹{totalPaid}</span>} />
                            ...
                            {!expired && (
                                <div className="mt-3 h-2 bg-white/10 rounded-full overflow-hidden">
                                    <motion.div
                                        ...
                                        animate={{ width: `${Math.max(0, ((expiresAtMs - Date.now()) / (totalDuration * 3600000)) * 100).toFixed(1)}%` }}
                ...
                >
                    <button onClick={handleExtend} className="flex items-center justify-center gap-2 py-4 rounded-xl font-bold text-white border border-neon-blue/40 bg-neon-blue/10 hover:bg-neon-blue/20 hover:border-neon-blue/60 hover:shadow-[0_0_20px_rgba(59,130,246,0.3)] transition-all">
                        <FaPlus /> Extend Parking
                    </button>
                    <button onClick={handleEndParking} className={`flex items-center justify-center gap-2 py-4 rounded-xl font-bold transition-all ${expired ? "bg-neon-red text-white hover:bg-red-500 shadow-[0_0_20px_rgba(239,68,68,0.5)] animate-pulse" : "bg-gradient-to-r from-neon-red/80 to-neon-red text-white hover:shadow-[0_0_20px_rgba(239,68,68,0.4)]"}`}>
                        <FaStop /> End Parking
                    </button>
                </motion.div>
